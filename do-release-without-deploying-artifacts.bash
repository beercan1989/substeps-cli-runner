...
mvn --batch-mode release:prepare --projects '!substeps-restdriver' -Dtag="${RELEASE_VERSION}" -DreleaseVersion="${RELEASE_VERSION}" -DdevelopmentVersion="${NEXT_SNAP_VERSION}" -DautoVersionSubmodules=true
